...
// ATTACHMENTS - HANDGUN
_hg_silencer1 = "RH_gemtech9";	// Glock Suppressor
...
// Backpacks
_bagsmall = "B_Bergen_mcamo";		// carries 120, weighs 20
...
_baseUniform = ["U_mas_uk_B_CombatUniform_mcam2_vest","U_mas_uk_B_CombatUniform_mcam", "U_mas_uk_B_CombatUniform_mcam"];
_baseHelmet = ["H_mas_uk_HelmetB","H_mas_uk_HelmetB_paint","H_mas_uk_HelmetB_light"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_mas_uk_PlateCarrier2_rgr","V_mas_uk_PlateCarrierGL_rgr"];
_mediumRig = ["V_mas_uk_PlateCarrier1_rgr","V_mas_uk_PlateCarrierGL_rgr","V_mas_uk_PlateCarrier2_rgr"]; 	// default for all infantry classes
_heavyRig = ["V_mas_uk_PlateCarrier1_rgr"];

// Commander
_coUniform = ["U_mas_uk_B_CombatUniform_mcam3_vest"];
_coHelmet = ["H_mas_uk_bereta"];
_coRig = _mediumRig;
_coGlasses = [];
...
// Pilot
_pilotUniform = ["U_mas_uk_B_pilot"];
_pilotHelmet = ["H_mas_uk_PilotHelmetHeli_B"];
_pilotRig = ["V_mas_uk_TacVest_p"];
_pilotGlasses = [];
...
_backpack = {
	...
	{
		#include "f_assignGear_UK_b_1T.sqf";
	};
};
