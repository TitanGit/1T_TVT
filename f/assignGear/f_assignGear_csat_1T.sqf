...
_hg_scope1 = "optic_MRD";			//MRD Optic
...
// Commander
_coUniform = ["U_O_OfficerUniform_ocamo"];
_coHelmet = ["H_Beret_blk"];
_coRig = _mediumRig;
_coGlasses = [];
...
// Crewman
_crewUniform = ["U_I_HeliPilotCoveralls"];
...
_backpack = {
	...
	{
		#include "f_assignGear_csat_b_1T.sqf";
	};
};
