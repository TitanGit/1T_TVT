...
_baseUniform = ["U_IG_Guerilla3_2","U_IG_Guerilla3_1","U_IG_leader"];
_baseHelmet = ["H_Booniehat_dirty","H_ShemagOpen_khk","H_Shemag_olive_hs","H_mas_uk_bandana"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_brn","V_HarnessOGL_brn"];
_mediumRig = ["V_TacVest_brn","V_HarnessOGL_brn"]; 	// default for all infantry classes
_heavyRig = ["V_PlateCarrierH_CTRG"];

// Commander
_coUniform = ["U_mas_afr_B_contract2"];
_coHelmet = ["H_Shemag_olive_hs"];
_coRig = _mediumRig;
_coGlasses = [];
...
// Pilot
_pilotUniform = ["U_IG_Guerilla2_3"];
...
_backpack = {
	...
	{
		#include "f_assignGear_AFR_b_1T.sqf";
	};
};
