...
// Backpacks
_bagsmall = "B_FieldPack_mcamo";		// carries 120, weighs 20
_bagmedium = "B_FieldPack_mcamo";		// carries 240, weighs 30
...
_backpack = {
	...
	{
		#include "f_assignGear_nato_b_1T.sqf";
	};
};
