...
// TRUE = Disable frequency separation across sides
...
// empty array means that no one gets a short wave
f_radios_settings_acre2_shortRange = nil;

// Set the list of units that get a long range
f_radios_settings_acre2_longRange = ["co", "dc", "ftl", "m", "mmgg", "matg", "mtrg", "sn","vc", "pp", "eng", "engm", "uav", "div"];
...
/*
Effectively disabled this via setting all factions to use same language, to enable babel just change the languages - Titan
*/
